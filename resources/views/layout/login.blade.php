    ...
    <style>
        ...
        *::after {
        ...
        body {
            ...
            background: -moz-linear-gradient(-45deg, rgb(64, 223, 120) 0%, rgb(64, 223, 96) 100%);
            background: -webkit-linear-gradient(-45deg, rgb(128, 218, 41) 0%, rgb(64, 223, 90) 100%);
            background: -o-linear-gradient(-45deg, rgb(128, 218, 41) 0%, rgb(64, 223, 120) 100%);
            background: -ms-linear-gradient(-45deg, rgb(128, 218, 41) 0%, rgb(98, 223, 64) 100%);
            background: linear-gradient(135deg, rgb(64, 223, 120) 0%, rgb(93, 223, 64) 100%);
